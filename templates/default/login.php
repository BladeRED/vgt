...
<main>
  ...
  ' . $error . '
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 mt-3 mb-5 py-5 ">
                    <div class="row">
                        <form class="mx-auto" method="post" action="index.php?controller=security&action=register">
                            <div class="form-group mx-5 px-5">
                                ...
                                <label for="mailRegister" class="mb-3 text-white"> Ton Adresse Mail: </label>
                                <input
                                        type="email"
                                        class="form-control log mx-auto"
                                        id="mailRegister"
                            ...
                            <div class="form-group  mx-5 px-5">
                                <label for="pseudoRegister" class="my-3 text-white"> Ton Pseudo: </label>
                                <input
                                        type="text"
                                        class="form-control log mx-auto"
                                        id="pseudoRegister"
                            ...
                            <div class="form-group mx-5 px-5">
                                <label for="passwordRegister" class="my-3 text-white">Mot de passe: </label>
                                <input
                                        type="password"
                                        class="form-control log mx-auto "
                                        id="passwordRegister"
                            ...
                            <div class="form-group  mb-4 mx-5 px-5">
                                <label for="passwordVerifRegister" class="my-3 text-white"> Vérifie ton mot de passe: </label>
                                <input
                                        type="password"
                                        class="form-control log mx-auto "
